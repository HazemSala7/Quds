...
class _MoneyMovementState extends State<MoneyMovement> {
  ...
  filterStatments() async {
    ...
    var url =
        'https://aliexpress.ps/quds_laravel/api/filter_statments_all_customers/$company_id/$salesman_id/${start_date.text}/${end_date.text}?page=$_page';
  ...
  void _firstLoad() async {
    ...
    try {
      var url =
          "https://aliexpress.ps/quds_laravel/api/statments_all_customers/${company_id.toString()}?page=$_page";
  ...
  getAllStatments() async {
    ...
    try {
      if (start_date.text == "" || end_date.text == "") {
        var url =
            "https://aliexpress.ps/quds_laravel/api/all_statments_with_all_customers/${company_id.toString()}";
        ...
        var url =
            "https://aliexpress.ps/quds_laravel/api/get_all_filter_statments_all_customers/$company_id/${start_date.text}/${end_date.text}";
        final res = await http.get(Uri.parse(url));
        setState(() {
